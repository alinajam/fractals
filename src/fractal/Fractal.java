...
public class Fractal {
	...
	private void drawKochCurve(Point2D p1, Point2D p2, int level) {
		...
		t.move(d/3);// TODO
		Point2D p3 = new Point2D.Double(t.getPosition().getX(), t.getPosition().getY());
		t.turnLeft(60);
		t.move(d/3);
		Point2D p4 = new Point2D.Double(t.getPosition().getX(), t.getPosition().getY());
		t.turnRight(120);
		t.move(d/3);
		Point2D p5 = new Point2D.Double(t.getPosition().getX(), t.getPosition().getY());
	...
	private void drawTree(Point2D p1, Point2D p2, int level) {
		...
		u.turnRight(15);
		u.move(2*d/3);
		Point2D p5 = new Point2D.Double(u.getPosition().getX(), u.getPosition().getY());
	...
	private void drawSierpinskiTriangle(Point2D p1, Point2D p2, Point2D p3, int level) {
		...
		Point2D midPointP1 = new Point2D.Double((p1.getX()+p2.getX())/2, (p1.getY()+p2.getY())/2);
		Point2D midPointP2 = new Point2D.Double((p1.getX()+p3.getX())/2, (p1.getY()+p3.getY())/2);
		Point2D midPointP3 = new Point2D.Double((p2.getX()+p3.getX())/2, (p2.getY()+p3.getY())/2);
		
		
		drawSierpinskiTriangle(p1,midPointP1,midPointP2, level-1);
		drawSierpinskiTriangle(midPointP1, p2, midPointP3, level-1);
		drawSierpinskiTriangle(midPointP2,midPointP3,p3, level-1);
		// TODO
	}
	...
	private void drawSierpinskiCarpet(Point2D p, double a, int level) {
		...
		Point2D sq1 = new Point2D.Double(p.getX(), p.getY());
		Point2D sq2 = new Point2D.Double(p.getX()+a/3, p.getY());
		Point2D sq3 = new Point2D.Double(p.getX()+2*a/3, p.getY());
		
		Point2D sq4 = new Point2D.Double(p.getX(), p.getY()+a/3);
		Point2D sq5 = new Point2D.Double(p.getX()+a/3, p.getY()+a/3);
		Point2D sq6 = new Point2D.Double(p.getX()+2*a/3, p.getY()+a/3);
		
		Point2D sq7 = new Point2D.Double(p.getX(), p.getY()+2*a/3);
		Point2D sq8 = new Point2D.Double(p.getX()+a/3, p.getY()+2*a/3);
		Point2D sq9 = new Point2D.Double(p.getX()+2*a/3, p.getY()+2*a/3);
		
		drawSierpinskiCarpet(sq1,a/3,level-1);
		drawSierpinskiCarpet(sq2,a/3,level-1);
		drawSierpinskiCarpet(sq3,a/3,level-1);
		drawSierpinskiCarpet(sq4,a/3,level-1);
		drawSierpinskiCarpet(sq6,a/3,level-1);
		drawSierpinskiCarpet(sq7,a/3,level-1);
		drawSierpinskiCarpet(sq8,a/3,level-1);
		drawSierpinskiCarpet(sq9,a/3,level-1);
		// TODO
	}
